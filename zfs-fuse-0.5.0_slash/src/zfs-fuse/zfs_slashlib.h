...
int zfsslash2_opencreate(void *, uint64_t, cred_t *, int, mode_t, const char *, fidgen_t *, struct stat *, file_info_t **);
int zfsslash2_opendir(void *, uint64_t, cred_t *, fidgen_t *, struct stat *, file_info_t **);
