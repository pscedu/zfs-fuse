...
int	zfsslash2_lookup(void *, uint64_t, const char *, struct slash_fidgen *, const struct slash_creds *, struct srt_stat *, int);
...
int	zfsslash2_opendir(void *, uint64_t, const struct slash_creds *, struct slash_fidgen *, struct srt_stat *, void **, int);
...
int	zfsslash2_setattr(void *, uint64_t, const struct srt_stat *, int, const struct slash_creds *, struct srt_stat *, void *);
