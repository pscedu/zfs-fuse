...
int	zfsslash2_getattr(void *, uint64_t, const struct slash_creds *, struct fcmh_stat *, uint64_t *);
int	zfsslash2_link(void *, uint64_t, uint64_t, const char *, struct slash_fidgen *, const struct slash_creds *, struct fcmh_stat *);
int	zfsslash2_lookup(void *, uint64_t, const char *, struct slash_fidgen *, const struct slash_creds *, struct fcmh_stat *);
int	zfsslash2_mkdir(void *, uint64_t, const char *, mode_t, const struct slash_creds *, struct fcmh_stat *, struct slash_fidgen *, int);
int	zfsslash2_mknod(void *, uint64_t, const char *, mode_t, dev_t);
int	zfsslash2_opencreate(void *, uint64_t, const struct slash_creds *, int, mode_t, const char *, struct slash_fidgen *, struct fcmh_stat *, void **);
int	zfsslash2_opendir(void *, uint64_t, const struct slash_creds *, struct slash_fidgen *, struct fcmh_stat *, void **);
...
int	zfsslash2_setattr(void *, uint64_t, const struct fcmh_stat *, int, const struct slash_creds *, struct fcmh_stat *, void *);
int	zfsslash2_statfs(void *, struct statvfs *, uint64_t);
int	zfsslash2_symlink(void *, const char *, uint64_t, const char *, const struct slash_creds *, struct fcmh_stat *, struct slash_fidgen *);
