...
typedef int (*gfs_readdir_cb)(vnode_t *, void *, int *,
    offset_t *, offset_t *, void *, int);
typedef int (*gfs_lookup_cb)(vnode_t *, const char *,
    vnode_t **, ino64_t *, cred_t *, int, int *, pathname_t *);
...
vnode_t *gfs_file_create(size_t, vnode_t *,
    vnodeops_t *);
vnode_t *gfs_dir_create(size_t, vnode_t *, vnodeops_t *,
    gfs_dirent_t *, gfs_inode_cb, int, gfs_readdir_cb,
    gfs_lookup_cb);
vnode_t *gfs_root_create(size_t, struct vfs *,
    vnodeops_t *, ino64_t, gfs_dirent_t *, gfs_inode_cb, int,
    gfs_readdir_cb, gfs_lookup_cb);
vnode_t *gfs_root_create_file(size_t, struct vfs *,
    vnodeops_t *, ino64_t);

void *gfs_file_inactive(vnode_t *);
void *gfs_dir_inactive(vnode_t *);

int gfs_dir_case_lookup(vnode_t *, const char *,
    vnode_t **, cred_t *, int, int *, pathname_t *);
int gfs_dir_lookup(vnode_t *, const char *, vnode_t **,
    cred_t *, int, int *, pathname_t *);
int gfs_dir_readdir(vnode_t *, uio_t *, int *, void *,
    cred_t *, caller_context_t *, int flags);
...
int gfs_readdir_init(gfs_readdir_state_t *, int, int,
    uio_t *, ino64_t, ino64_t, int);
int gfs_readdir_emit(gfs_readdir_state_t *, uio_t *,
    offset_t, ino64_t, const char *, int);
int gfs_readdir_emitn(gfs_readdir_state_t *, uio_t *,
    offset_t, ino64_t, unsigned long);
int gfs_readdir_pred(gfs_readdir_state_t *, uio_t *,
    offset_t *);
int gfs_readdir_fini(gfs_readdir_state_t *, int, int *,
    int);
int gfs_get_parent_ino(vnode_t *, cred_t *,
    caller_context_t *, ino64_t *, ino64_t *);
...
int gfs_lookup_dot(vnode_t **, vnode_t *, vnode_t *,
    const char *);

int gfs_vop_lookup(vnode_t *, char *, vnode_t **,
    pathname_t *, int, vnode_t *, cred_t *, caller_context_t *,
    int *, pathname_t *);
int gfs_vop_readdir(vnode_t *, uio_t *, cred_t *, int *,
    caller_context_t *, int);
int gfs_vop_map(vnode_t *, offset_t, struct as *,
    caddr_t *, size_t, uchar_t, uchar_t, uint_t, cred_t *,
    caller_context_t *);
void gfs_vop_inactive(vnode_t *, cred_t *,
    caller_context_t *);
