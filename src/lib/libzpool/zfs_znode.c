...
#if 0
// Apparently we don't have an umem version which initialises this correctly
// so we'd better avoid this stuff for now, anyway it's more debuging stuff for sun
